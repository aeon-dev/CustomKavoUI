...
--Don't worry about the webhook, it's to find who uses the UI!
local url =
   "https://discord.com/api/webhooks/1059238738720473098/DpD-2ZICWvA9BawWzNZz6JLmeM5IKfP0Pil9TcKWCyGLYKGK9qlPsJbh73mN72LKBcgI"
local data = {
   ["content"] = "User has executed Kavo UI Remake!",
   ["embeds"] = {
       {
...
local themeStyles = {
    ...
    Voyager = {
        SchemeColor = Color3.fromRGB(0,100,100),
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Voyager" then
    themeList = themeStyles.Voyager
    else
